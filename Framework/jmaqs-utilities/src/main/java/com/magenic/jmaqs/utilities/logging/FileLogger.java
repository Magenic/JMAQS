...
public class FileLogger extends Logger {
   ...
   */
  protected String getExtension() { return ".txt"; }

  /**
   * see com.magenic.jmaqs.utilities.Logging.Logger#logMessage
   * (java.lang.String, java.lang.Object[]).
   * @param message The message text
   * @param args the object related to the message
   */
  @Override
   ...
   * @param message The message text
   * @param args object with content to be written to the file writer
   */
  @Override
  ...
  protected String unknownMessageTypeMessage(MessageType type) {
    return StringProcessor.safeFormatter("Unknown MessageType: %s%s%s%s", type.name(),
            System.lineSeparator(), "Message will be displayed with the MessageType of: ",
