...
public class PerfTimerCollection {
     ...
     **/
    public static PerfTimerCollection loadPerfTimerCollection(String filepath) throws IOException {
        FileReader reader = new FileReader(filepath);
        XmlMapper xmlMapper = new XmlMapper();
        PerfTimerCollection perfTimerCollection = new PerfTimerCollection();
        // TODO: Complete method
        /**
        PerfTimerCollection perfTimerCollection = xmlMapper.copy(reader);
